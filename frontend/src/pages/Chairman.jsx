          ...
          <div className="modal-box bg-white rounded-lg sm:rounded-lg shadow-2xl max-w-xs sm:max-w-md md:max-w-2xl p-4 sm:p-6 md:p-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <fieldset className="fieldset border border-gray-300 rounded-lg p-3 sm:p-4 bg-gray-50">
                ...
                <textarea
                  className="input w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-md focus:border-red-600 focus:outline-none focus:ring-2 focus:ring-red-100 resize-none h-32 sm:h-40 text-gray-900 text-sm"
